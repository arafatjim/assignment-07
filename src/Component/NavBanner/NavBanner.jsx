...
const NavBanner = ({handleCoinOffer,offer}) => {
            return (
                                        <div 
                                                   className='mx-auto justify-center items-center w-11/12  px-2 flex gap-2 flex-col lg:h-auto relative rounded-lg bg-[#11263f] sm:w-11/12 h-84 py-2  lg:w-11/12 md:w-11/12 mt-56' 
