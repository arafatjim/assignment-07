                  ...
                  <div>
                              <div className='w-11/12 py-4 mx-auto px-2 flex flex-col justify-between items-center font-bold md:flex-row'>
                                    ...
                                    <div className='flex gap-2'>
                                          <button onClick={() => togglePlayers(showPlayers)} className='bg-yellow-500 rounded-md p-2'>
                                                  Available
                                          </button>
                                          <button className='bg-yellow-500 rounded-md p-2'>
                              ...
                              {/* <div className='w-11/12 py-4 mx-auto px-2 flex flex-col justify-between items-center font-bold md:flex-row'>
                                    <p className='text-3xl font-extrabold text-black'>Selected Players</p>
